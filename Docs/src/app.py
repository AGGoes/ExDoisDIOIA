...
from services.credit_card_service import analiza_credit_card

def configure_interface():
    st.title("Upload Arquivo Azure")
    ...
    if uploaded_file is not None:
        ...
        if blob_url:
            st.write(f"Arquivo {fileName} enviado com sucesso para o Azure")
            credit_card_info = analiza_credit_card(blob_url)
